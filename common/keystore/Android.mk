...
LOCAL_SRC_FILES_32         := lib/hw/gatekeeper.trusty.tegra.so
LOCAL_SRC_FILES_64         := lib64/hw/gatekeeper.trusty.tegra.so
LOCAL_MULTILIB             := both
LOCAL_MODULE_SUFFIX        := .so
LOCAL_MODULE_CLASS         := SHARED_LIBRARIES
LOCAL_MODULE_TAGS          := optional
...
LOCAL_SRC_FILES_32         := lib/hw/keystore.v0.tegra.so
LOCAL_SRC_FILES_64         := lib64/hw/keystore.v0.tegra.so
LOCAL_MULTILIB             := both
LOCAL_MODULE_SUFFIX        := .so
LOCAL_MODULE_CLASS         := SHARED_LIBRARIES
LOCAL_MODULE_TAGS          := optional
