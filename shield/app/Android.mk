...
include $(CLEAR_VARS)
LOCAL_MODULE := Beyonder
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := Beyonder/Beyonder.apk
...
include $(CLEAR_VARS)
LOCAL_MODULE := RemoteInput
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := RemoteInput/RemoteInput.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_APPS)
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := AccessoryUiTv/AccessoryUiTv.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_PRIVILEGED_MODULE := true
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := TegraZone_Next/TegraZone_Next.apk
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_APPS)
...
LOCAL_SRC_FILES := TegraZone_Next/lib/libadaptordecoder.so
