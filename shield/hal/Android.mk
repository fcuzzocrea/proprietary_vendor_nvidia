...
LOCAL_SRC_FILES := lib/hw/gatekeeper.trusty.tegra.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TARGET_ARCH := arm
LOCAL_MODULE_PATH := $($(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw
...
include $(CLEAR_VARS)
LOCAL_MODULE := gatekeeper.trusty.tegra
LOCAL_SRC_FILES := lib64/hw/gatekeeper.trusty.tegra.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TARGET_ARCH := arm64
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw
...
include $(CLEAR_VARS)
LOCAL_MODULE := vendor.nvidia.hardware.graphics.composer@1.0-service.rc
LOCAL_SRC_FILES := etc/init/vendor.nvidia.hardware.graphics.composer@1.0-service.rc
